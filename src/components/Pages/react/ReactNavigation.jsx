...
const NavItem = ({ to, icon: Icon, label }) => (
  <Link
    to={to}
    className="flex items-center p-4 rounded-lg transition-colors hover:bg-blue-100 dark:hover:bg-blue-900"
  >
...
const ReactNavigation = ({ reactLogo }) => {
  ...
  return (
    ...
    <h2 className="text-2xl font-bold mb-6 text-center text-gray-800 dark:text-white">React Topics</h2>
