  ...
  return (
    ...
    <div className='container'>
      ...
      <p className='text-xl'>
        ...
        programmers are lazy and don't want to write the same code over and over
        again. This way we don't have to!{" "}
      </p>
      <p className='text-xl'>
        So now that we have established that loops are a good thing, let's learn
        about the different types of loops in JavaScript.
      </p>
      <hr className='border-black my-5 dark:border-white' />
      <h2 className='text-4xl py-2'>For Loop </h2>
      <p className='text-xl'>
        The for loop is the most commonly used loop in JavaScript. It repeats a
        block of code a specified number of times. <br /> Here's an example of a
        for loop:
      </p>
      <pre>
      ...
      <p className='text-xl'>
        The for loop has three parts: the initialization, the condition, and the
        final expression. The initialization is where you set the starting value
        of the loop. The condition is where you specify when the loop should
        stop. The final expression is where you specify what should happen after
      ...
      <p className='text-xl'>
        ...
        is true. This is useful when you don't know how many times you need to
        run the loop. It is one you will use less, but it is still good to know.{" "}
      ...
      <p className='text-xl'>
        ...
        specify when the loop should stop. In the example above, the loop starts
        with i equal to 0. The loop will continue as long as i is less than 5.
      ...
      <p className='text-xl'>
        ...
        condition is true. This is useful when you want to run the loop at least
        once, even if the condition is false. <br /> Here's an example of a
        do...while loop:
      </p>
      <pre>
        <code ref={codeRef} className='language-javascript p-2'>
      ...
      <p className='text-xl'>
        The do...while loop has two parts: the block of code to be executed and
        the condition. The block of code is where you specify the instructions
        to be executed. The condition is where you specify when the loop should
        stop. In the example above, the loop starts with i equal to 0. The loop
        will continue as long as i is less than 5. After each iteration, i is
        incremented by 1.
      </p>
      ...
      <ul>
        <li className='list-disc'>
          The for loop is the most commonly used and a real world use case would
          be when you know exactly how many times you want to run the loop. So
          you might use it for something like iterating through an array.
        </li>
        <li className='list-disc'>
          The while loop is useful when you don't know how many times you want
          to run the loop. So you might use it for something like waiting for a
          user to input a specific value.
        </li>
        <li className='list-disc'>
