      ...
      <div className="container">
        ...
        <div className="my-10">
          ...
          <p className="text-2xl my-10">
            ...
            such as map, filter, and reduce. Arrow functions are also useful
            when using setTimeout and setInterval.
          </p>
          <p className="text-2xl my-10">
            One of the most useful is that you can use them in buttons to
            prevent the function from being called immediately.
          </p>
          ...
          <p className="text-2xl my-10">
            In this example, we have a button that when clicked will log "Button
            was clicked!" to the console. The arrow function is used to prevent
            the function from being called immediately.
          </p>
        </div>
      </div>
    </div>
