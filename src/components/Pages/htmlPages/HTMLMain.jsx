...
const HTMLMain = () => {
  const navItems = [
    ...
    { to: "/htmlPages/Tables", icon: Table, label: "Making Tables" },
    { to: "/htmlPages/Forms", icon: TextCursorInput, label: "Making Forms" },
    { to: "/htmlPages/HTMLImages", icon: Image, label: "Using Images" },
