...
<meta property="og:image" content={`${process.env.PUBLIC_URL}/src/assets/helpcodeitsociallogo.png`} />
...
<meta property="twitter:image" content={`${process.env.PUBLIC_URL}/src/assets/helpcodeitsociallogo.png`} />
