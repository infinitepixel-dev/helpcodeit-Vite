...
const GitHubAuthentication = () => {
  ...
  return (
    <div className='container mx-auto p-4 mb-14'>
      ...
      <h2 className='text-2xl mt-10 font-semibold mb-3'>1. Open VSCode</h2>
      <p>Open Visual Studio Code on your computer.</p>

      <h2 className='text-2xl mt-10 font-semibold mb-3'>2. Sign in to GitHub</h2>
      <p>
      ...
      <h2 className='text-2xl mt-10 font-semibold mb-3'>3. Authorize Access</h2>
      <p>
      ...
      <h2 className='text-2xl mt-10 font-semibold mb-3'>4. Return to VSCode</h2>
      <p>Once authorized, return to VSCode. You should see a notification confirming that you have successfully signed in.</p>

      <h2 className='text-2xl mt-10 font-semibold mb-3'>5. Verify Authentication</h2>
      <p>
      ...
      <h2 className='text-2xl mt-10 font-semibold mb-3'>Troubleshooting</h2>
      <p>
      ...
      <h2 className='text-2xl mt-10 font-semibold mb-3'>Setting Up a New Repository</h2>
      <p>
...
git push -u origin master`}
      ...
      <p>
        This will prompt you to authenticate if you haven't already. After authenticating, your code will be pushed to GitHub. In most cases the page stays blank, but the code in the termainal should show that the push was successful before you even make it back to vscode.
      </p>
      <div className='text-center mt-10'>
        <a href='#top' className='text-blue-500 text-xl font-bold hover:underline'>Back to top</a> <br /> <br />
        <Link to='/githubPages/GitHub' className='text-blue-500 text-xl font-bold hover:underline'>GitHub Home</Link>
      </div>
    </div>
  );
};
