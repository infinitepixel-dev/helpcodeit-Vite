...
const UpcomingEvents = ({ limit = Infinity, title = "Upcoming Events" }) => {
  ...
  return (
    ...
    <Link
      to="/schedule-meeting"
      className="inline-flex items-center px-6 py-3 text-base mb-5 shadow-md bg-blue-700 font-bold dark:border-none border border-1 border-gray-300 rounded-3xl"
    >
