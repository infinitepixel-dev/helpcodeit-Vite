...
const events = [
    {
        ...
        description:
            'This class will cover Git and GitHub Basics. This will have an overview of how to setup and use Git with GitHub, and will also cover branching, common terminology, pull requests, issues, and other basics.The highlight of this class will be the hands-on practice of using Git and GitHub to collaborate on a example project.',
        cost: '10',
        show: true,
    },
    {
        ...
        description:
            'This class will cover the basics of using JavaScript libraries. This will have an overview of how to setup and use JavaScript libraries, and will also cover common libraries, how to use them, and how to find and use new libraries. The highlight of this class will be the hands-on practice of using a few different libraries in a example project.',
        cost: '10',
        show: false,
    },
    {
